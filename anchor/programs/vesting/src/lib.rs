...
declare_id!("2Kb8uGtxVrwcE2LTdTeg2CbRqqemNvbjTah7FKYU532a");
...
pub struct ClaimTokens<'info> {
    ...
    #[account(
        mut,
        seeds = [b"employee_vesting", beneficiary.key().as_ref(), employee_account.vesting_account.as_ref()],
